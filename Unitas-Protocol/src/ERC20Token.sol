...
contract ERC20Token is ERC20, Pausable, AccessControl {
     ...
     */
    constructor(string memory name_, string memory symbol_, address governor_, address guardian_, address minter_)
        ERC20(name_, symbol_)
    {
     ...
     */
    function getBlacklist(address addr) public view onlyGuardian returns (bool) {
